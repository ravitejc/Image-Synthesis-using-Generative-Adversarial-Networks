import math
import numpy as np 
import DCGAN-tensorflowrflow as tf
...
def xavier_conv2d(input_, output_dim, k_h=5, k_w=5, d_h=2, d_w=2, stddev=0.02,
				  name="conv2d"):
	with tf.variable_scope(name):
...
def transpose_conv2d(input_, output_shape, k_h=5, k_w=5, d_h=2, d_w=2, stddev=0.02,
